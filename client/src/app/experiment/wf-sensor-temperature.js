angular.module('wellFollowed').directive('wfSensorTemperature', function(createChangeStream) {
    return {
        restrict: 'E',
        ...
        link: function(scope, element, attributes, wfExperiment) {
            var src = new EventSource('/api/SensorValues/watchValues/' + scope.sensor.name);
